...
from .views import MainPage, GymSearch, PremiumPump, AboutUs, getSerializedGymAndCityData, getSerializedWorkoutPlansData, getSerializedExercisesData, deleteWorkoutPlan
